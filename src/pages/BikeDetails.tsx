        ...
        <section className="max-w-6xl mx-auto p-4 sm:p-6 bg-gray-200">
          <div className="flex flex-col lg:flex-row gap-8 lg:items-stretch">
            ...
            <div className="lg:w-1/2 flex flex-col justify-between min-h-full">
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-black mb-4">Royal Enfield Classic 350</h1>
                ...
                {[...Array(5)].map((_, i) => (
                  <button 
                    ...
                    className={`text-lg transition-colors ${
                      i < review1Rating ? 'text-yellow-400 hover:text-yellow-500' : 'text-white hover:text-yellow-400'
                    }`}
                  >
                    ★
                  </button>
              ...
              <div className="flex mb-3">
                {[...Array(5)].map((_, i) => (
                  <button 
                    ...
                    className={`text-lg transition-colors ${
                      i < review2Rating ? 'text-yellow-400 hover:text-yellow-500' : 'text-white hover:text-yellow-400'
                    }`}
                  >
                    ★
                  </button>
              ...
              <div className="flex mb-3">
                {[...Array(5)].map((_, i) => (
                  <button 
                    ...
                    className={`text-lg transition-colors ${
                      i < review3Rating ? 'text-yellow-400 hover:text-yellow-500' : 'text-white hover:text-yellow-400'
                    }`}
                  >
                    ★
                  </button>
